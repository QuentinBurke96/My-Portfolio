...
<div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-lg">
  <div className="fixed bottom-20 -left-1 w-72 h-72 bg-cyan-800 rounded-full"></div>
  <div className="fixed bottom-20 -right-1 w-72 h-72 bg-yellow-200 rounded-full"></div>
  <div className="fixed -bottom-1 w-72 h-72 bg-green-600 rounded-full"></div>
</div>
